...
const x = {
  ...
  reservation: {
    ...
    id: '5a4552a7-c601-4b71-ba8c-21c564eb441f',
    inventoryPool: '{id: "8bd16d45-056d-5590-bc7f-12849f034351", name: …}',
    model: '{id: "bc735842-780a-5306-b811-18acfd64d09b", images…}',
    startDate: '2020-12-14T00:00:00Z',
    status: 'UNSUBMITTED',
    user: '{id: "7da6733c-c819-5613-8cad-2a40f51c90da"}'
  },
  imageUrl: '/app/borrow/images/9b4780a0-65ab-46e6-a6a6-b2cbcaf8a604',
  pools: ['{id: "8bd16d45-056d-5590-bc7f-12849f034351", name: …}'],
  quantity: 1,
  onEdit: 'ƒ () {}',
  onDelete: 'ƒ () {}'
}
